...
const projects = [
  {
    ...
    image: "https://i.ibb.co/L7Ss3S5/e-commerce-front.png",
  ...
  },
  {
    ...
    image: "https://i.ibb.co/0V9rLJN3/plant-Care-front.png",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:gap-12">
          {projects.map((project) => (
            ...
            >
              {/* Image */}
              <div className="lg:w-1/2 w-full h-auto lg:h-[550px] relative overflow-hidden">
                <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gray-100 dark:bg-gray-700">
                  <figure className="w-full h-full p-4 overflow-hidden">
                    <img
                      src={project.image}
                      alt={project.title}
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-indigo-600 dark:hover:bg-indigo-400 hover:text-white transition-colors duration-200 text-center"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 dark:bg-indigo-400 text-white dark:text-gray-900 rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-500 transition-colors duration-200 text-center"
                    >
